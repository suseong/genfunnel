function [coeff1_,coeff3_,S_,cheat_] = findL(dt,P,Q,rho,rhodot,initRegion,Kp,Kd)
...
%        vars = [coeff1;coeff3;coeff4;coeff5;coeff6;coeff7;coeff12;coeff13;coeff14;coeff15;S(:)];
% 
%        sol = solvesos([c1      c4 c5 c6 c7 c8 c9 c10 c11 c12],-geomean(S),[],vars);
% 
%        if sol.problem == 0
