...
xinit =  [3*(rand(1,2)-0.5) 0];
xfinal = [3*(rand(1,2)-0.5) 0];

yinit =  [3*(rand(1,2)-0.5) 0];
yfinal = [3*(rand(1,2)-0.5) 0];

zinit =  [3*(rand(1,2)-0.5) 0];
zfinal = [3*(rand(1,2)-0.5) 0];
...
if ~isempty(tfRange)
    ...
    [xp1,xv1] = show_pv(xtsq,xacc,xinit,[20 xAccRefined],-xnum,100);
    [yp1,yv1] = show_pv(ytsq,yacc,yinit,[20 yAccRefined],-ynum,100);
    [zp1,zv1] = show_pv(ztsq,zacc,zinit,[20 zAccRefined],-znum,100);
