function [pos,acc,tsq] = calc_4_4(input,initState,finalState,tf)
...
if or(cond_pos, cond_neg)
    ...
    t1 = -(a0 - am)/u;
    t4 = tf + (af + am)/u;
    t3 = (a0^2 - 2*a0*am + af^2 + 2*af*am + 6*am^2 + 2*tf*u*am - 2*u*v0 + 2*u*vf)/(4*am*u);
    t2 = -(2*am - t3*u)/u;
...
% test
% [a,b,c] = calc_4_4( [20 5], [0 0 -10], [-3.75 -5 -10],2.25)
% [a,b,c] = calc_4_4(-[20 5],-[0 0 -10],-[-3.75 -5 -10],2.25)
